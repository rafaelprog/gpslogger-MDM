...
import com.formmicro.gpslogger.loggers.nmea.NmeaSentence;
...
class GeneralLocationListener implements LocationListener, GpsStatus.Listener, GpsStatus.NmeaListener {
    ...
    private static com.formmicro.gpslogger.GpsLoggingService loggingService;
    ...
    GeneralLocationListener(com.formmicro.gpslogger.GpsLoggingService activity, String name) {
