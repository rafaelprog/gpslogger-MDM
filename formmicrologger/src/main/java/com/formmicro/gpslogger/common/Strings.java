...
import com.formmicro.gpslogger.BuildConfig;
...
public class Strings {
    ...
    public static String getIsoDateTime(Date dateToFormat) {
        /**
         * This function is used in formmicrologger.loggers.* and for most of them the
    ...
    public static String getFormattedFileName(){
        return getFormattedFileName(com.formmicro.gpslogger.common.Session.getInstance(), com.formmicro.gpslogger.common.PreferenceHelper.getInstance());
    }

    public static String getFormattedFileName(com.formmicro.gpslogger.common.Session session, com.formmicro.gpslogger.common.PreferenceHelper ph) {
    ...
    public static String getFormattedCustomFileName(String baseName, Calendar calendar, com.formmicro.gpslogger.common.PreferenceHelper ph){
    ...
    public static String getSanitizedMarkdownForFaqView(String md){
        ...
        while(linkMatcher.find()){
            ...
            output = output.replace(group,"http://code.mendhak.com/formmicrologger/"+group);
        }
    ...
    public static String getFormattedLatitude(double decimaldegrees){
        return getFormattedDegrees(decimaldegrees, true, com.formmicro.gpslogger.common.PreferenceHelper.getInstance());
    }

    public static String getFormattedLongitude(double decimaldegrees){
        return getFormattedDegrees(decimaldegrees, false, com.formmicro.gpslogger.common.PreferenceHelper.getInstance());
    }

    static String getFormattedDegrees(double decimaldegrees, boolean isLatitude, com.formmicro.gpslogger.common.PreferenceHelper ph){
