package com.formmicro.gpslogger.loggers.gpx;
 ...
 */
public class Gpx11FileLogger extends com.formmicro.gpslogger.loggers.gpx.Gpx10FileLogger {
...
class Gpx11WriteHandler extends com.formmicro.gpslogger.loggers.gpx.Gpx10WriteHandler {
    ...
    String getBeginningXml(String dateTimeString){
        ...
        initialXml.append("<gpx version=\"1.1\" creator=\"Formmicro " + BuildConfig.VERSION_CODE + " - http://formmicrologger.mendhak.com/\" ");
