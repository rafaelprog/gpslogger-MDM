...
import com.formmicro.gpslogger.senders.FileSenderFactory;
import com.formmicro.gpslogger.ui.Dialogs;
import com.formmicro.gpslogger.ui.components.GpsLoggerDrawerItem;
import com.formmicro.gpslogger.ui.fragments.display.*;
...
public class GpsMainActivity extends AppCompatActivity
    ...
    private void loadPresetProperties() {
        ...
        //Either look for /<appfolder>/formmicrologger.properties or /sdcard/formmicrologger.properties
        File file =  new File(Files.storageFolder(getApplicationContext()) + "/formmicrologger.properties");
        if(!file.exists()){
            file = new File(Environment.getExternalStorageDirectory() + "/formmicrologger.properties");
            if(!file.exists()){
                return;
            }
        }
    ...
    public void setUpNavigationDrawer(Bundle savedInstanceState) {
        ...
        //materialDrawer.addItem(formmicrologgerDrawerItem.newPrimary(R.string.pref_autosend_title, R.string.pref_autosend_summary, R.drawable.autosend, 1003));
        //materialDrawer.addItem(formmicrologgerDrawerItem.newSecondary(R.string.gdocs_setup_title, R.drawable.googledrive, 1004));
        //materialDrawer.addItem(formmicrologgerDrawerItem.newSecondary(R.string.dropbox_setup_title, R.drawable.dropbox, 1005));
        //materialDrawer.addItem(formmicrologgerDrawerItem.newSecondary(R.string.sftp_setup_title, R.drawable.sftp, 1015));
        //materialDrawer.addItem(formmicrologgerDrawerItem.newSecondary(R.string.opengts_setup_title, R.drawable.opengts, 1008));
        //materialDrawer.addItem(formmicrologgerDrawerItem.newSecondary(R.string.osm_setup_title, R.drawable.openstreetmap, 1009));
        //materialDrawer.addItem(formmicrologgerDrawerItem.newSecondary(R.string.autoemail_title, R.drawable.email, 1006));
        //materialDrawer.addItem(formmicrologgerDrawerItem.newSecondary(R.string.owncloud_setup_title, R.drawable.owncloud, 1010));
        //materialDrawer.addItem(formmicrologgerDrawerItem.newSecondary(R.string.autoftp_setup_title, R.drawable.ftp, 1007));

        //materialDrawer.addItem(new DividerDrawerItem());

        //materialDrawer.addStickyFooterItem(formmicrologgerDrawerItem.newSecondary(R.string.menu_faq, R.drawable.helpfaq, 9000));
    ...
    private void populateProfilesList() {
        ...
        File formmicrologgerDir = Files.storageFolder(this);
        File[] propertyFiles = formmicrologgerDir.listFiles(new FilenameFilter() {
            @Override
