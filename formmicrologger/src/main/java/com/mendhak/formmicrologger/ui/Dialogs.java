...
package com.formmicro.gpslogger.ui;
        ...
        MaterialDialog alertDialog = new MaterialDialog.Builder(context)
                ...
                .onNegative(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog materialDialog, @NonNull DialogAction dialogAction) {
                        ...
                        android.content.ClipData clip = android.content.ClipData.newPlainText("formmicrologger error message", getFormattedErrorMessageForPlainText(errorMessage, throwable));
