...
//        try {
//
//            aboutInfo.setTitle("Formmicro version " + getActivity().getPackageManager().getPackageInfo(getActivity().getPackageName(), 0).versionName);
...
//            intent.putExtra(Intent.EXTRA_SUBJECT, "Formmicro Debug Log");
//
...
//                    Uri.parse("market://details?id=com.formmicro.gpsvisualizer"));
