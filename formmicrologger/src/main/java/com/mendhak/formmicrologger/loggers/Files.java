...
public class Files {
    /**
     * Gets the Formmicro-specific MIME type to use for a given filename/extension
     *
     * @param fileName
     * @return
     */
    ...
    public static boolean isAllowedToWriteTo(String formmicrologgerFolder) {
        return new File(formmicrologgerFolder).canWrite();
    }
...
//                    Log.e(TAG, "Error closing asset " + name);
    ...
    public static File createTestFile() throws IOException {
        ...
        File testFile = new File(gpxFolder.getPath(), "formmicrologger_test.xml");
        if (!testFile.exists()) {
