...
import com.formmicro.gpslogger.common.RejectionHandler;
...
class Gpx10WriteHandler implements Runnable {
    ...
    String getBeginningXml(String dateTimeString){
        ...
        initialXml.append("<gpx version=\"1.0\" creator=\"Formmicro " + BuildConfig.VERSION_CODE + " - http://formmicrologger.mendhak.com/\" ");
