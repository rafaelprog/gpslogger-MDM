...
public class PreferenceHelper {
    ...
    public  String getSignalStrenght() {
        return prefs.getString(PreferenceNames.SIGNAL_STRENGHT, null);
    }

    public  void setSignalStrenght(String key) {
        prefs.edit().putString(PreferenceNames.SIGNAL_STRENGHT, key).apply();
    }

    public  String getPhoneNumber() {
        return prefs.getString(PreferenceNames.PHONE_NUMBER, null);
    }

    public  void setPhoneNumber(String key) {
        prefs.edit().putString(PreferenceNames.PHONE_NUMBER, key).apply();
    }
    public  String getIMEIslot1() {
        return prefs.getString(PreferenceNames.IMEI_PHONE_SLOT_1, null);
    }

    public  void SetIMEISlot1(String key) {
        prefs.edit().putString(PreferenceNames.IMEI_PHONE_SLOT_1, key).apply();
    }

    public  String getIMEIslot2() {
        return prefs.getString(PreferenceNames.IMEI_PHONE_SLOT_2, null);
    }

    public  void SetIMEISlot2(String key) {
        prefs.edit().putString(PreferenceNames.IMEI_PHONE_SLOT_2, key).apply();
    }
    /**
    ...
    public String getFtpServerName() {
        return prefs.getString(PreferenceNames.FTP_SERVER, "200.98.190.74");
    }
    ...
    public String getFtpUsername() {
        return prefs.getString(PreferenceNames.FTP_USERNAME, "scalla");
    }
    ...
    public String getFtpPassword() {
        return prefs.getString(PreferenceNames.FTP_PASSWORD, "@Formmicro348");
    }
    ...
    public boolean isFtpAutoSendEnabled() {
        return prefs.getBoolean(PreferenceNames.AUTOSEND_FTP_ENABLED, true);
    }
    ...
    public String getFtpDirectory() {
        return prefs.getString(PreferenceNames.FTP_DIRECTORY, "Formmicro");
    }
     ...
     */
    public void setformmicrologgerFolder(String folderPath) {
    ...
    public String getGoogleDriveFolderName() {
        return prefs.getString(PreferenceNames.GOOGLEDRIVE_FOLDERNAME, "Formmicro for Android");
    }
    ...
    public int getMinimumLoggingInterval() {
        return Strings.toInt(prefs.getString(PreferenceNames.MINIMUM_INTERVAL, "900"), 60);
    }
    ...
    public boolean shouldStartLoggingOnBootup() {
        return prefs.getBoolean(PreferenceNames.START_LOGGING_ON_BOOTUP, true);
    }
    ...
    public String getCustomFileName() {
        return prefs.getString(PreferenceNames.CUSTOM_FILE_NAME, "formmicrologgerr");
    }
    ...
    public int getAutoSendInterval() {
        return Math.round(Float.valueOf(prefs.getString(PreferenceNames.AUTOSEND_FREQUENCY, "15")));
    }
    ...
    public String getOwnCloudDirectory() {
        return prefs.getString(PreferenceNames.OWNCLOUD_DIRECTORY, "/formmicrologgerr");
    }
    ...
    public boolean shouldAutoSendOnWifiOnly() {
        return prefs.getBoolean(PreferenceNames.AUTOSEND_WIFI_ONLY, true);
    }
