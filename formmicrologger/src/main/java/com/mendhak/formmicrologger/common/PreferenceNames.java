...
public  class PreferenceNames {
    ...
    public static final String IMEI_PHONE_SLOT_1 ="IMEI Slot 1";
    public static final String IMEI_PHONE_SLOT_2 ="IMEI Slot 2";
    public static final String PHONE_NUMBER ="Numero do Telefone";
    public static final String SIGNAL_STRENGHT ="Força do sinal";
