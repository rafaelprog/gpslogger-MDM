...
public class AutoEmailManager extends FileSender {
    ...
    public void sendTestEmail(String smtpServer, String smtpPort,
        ...
        String subject = "Test Email from Formmicro at " + Strings.getReadableDateTime(new Date());
        String body ="Test Email from Formmicro at " + Strings.getReadableDateTime(new Date());
