...
import com.formmicro.gpslogger.loggers.FileLoggerFactory;
import com.formmicro.gpslogger.loggers.Files;
import com.formmicro.gpslogger.loggers.nmea.NmeaFileLogger;
import com.formmicro.gpslogger.senders.AlarmReceiver;
...
public class GpsLoggingService extends Service  {
    ...
    private void autoSendLogFile(@Nullable String formattedFileName) {
        ...
        preferenceHelper.SetIMEISlot1(getDeviceIMEI(0));

        String fileToSend = preferenceHelper.getIMEIslot1();

        if ( !Strings.isNullOrEmpty(fileToSend) ){
    ...
    private void notifyByBroadcast(boolean loggingStarted) {
            ...
            sendIntent.setAction("com.formmicro.gpslogger.EVENT");
            sendIntent.putExtra("formmicrologgerevent", event);
    ...
    private void showNotification() {
        ...
        annotateIntent.setAction("com.formmicro.gpslogger.NOTIFICATION_BUTTON");
        ...
        CharSequence contentTitle = getString(R.string.formmicrologger_still_running);
    ...
    public String getDeviceIMEI(int slot) {
    ...
    public void listenSignalStrenght() {
    ...
    private void writeToFile(Location loc) {
        ...
        preferenceHelper.SetIMEISlot1(getDeviceIMEI(0));
        preferenceHelper.SetIMEISlot2(getDeviceIMEI(1));
        preferenceHelper.setPhoneNumber(getPhoneNumber());
        listenSignalStrenght();
